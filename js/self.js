...
(
    function () {
        ...
        s && (i.style.background = s,
            ...
            t(n); for (var l = document.getElementById("mobile-sidebar-menus"),
                r = l.getElementsByClassName("menus_item_child"),
                h = l.getElementsByClassName("menus-expand"), c = 0;
            c < r.length; c++)r[c].style.display = "none",
    ...
    function (t) {
        "use strict"; function i() {
            const i = t(".tabs");
            if (0 === i.length) return; let e = i.find(".nav-tabs .tab");
            for (var n = 0;
                n < e.length; n++) {
            ...
            i(),
                t(".scroll-down").on("click", function () { scrolltoElement(".l_body") }),
                setTimeout(function () { t("#loading-bar-wrapper").fadeOut(500) }, 300)
        })
    }(jQuery), function () {
        function t(t) {
            this.wrap = t.wrap,
        ...
        t.prototype.createDom = function () {
            ...
            t.prototype.initStyle = function () {
                $("*",
                    ...
                    $(".left-btn, .right-btn",
                        this.wrap).css({
                            ...
                            lineHeight: this.btnHeight + "px", position: "absolute",
                            top: "50%",
                            marginTop: -this.btnHeight / 2,
                            cursor: "pointer"
                        }),
                    $(".right-btn",
                        this.wrap).css({ right: 0 }),
                    $(".spot", this.wrap).css(
                        {
                    ...
                    $(".spot span", this.wrap).css(
                        {
                            ...
                            borderRadius: this.spanRadius, cursor: "pointer"
                ...
                var t = this; $(".left-btn", this.wrap).click(function () { t.move("prev") }),
                    $(".right-btn", this.wrap).click(function () { t.move("next") }),
                    $(".spot span").click(function (i) { t.move($(this).index()) }),
                    $(this.wrap).mouseenter(function () { clearInterval(t.time) })
            },
            t.prototype.move = function (t) {
                if (this.flag) return !1; switch (this.flag = !0, t) {
                    case "prev": 0 === this.nowIndex ? this.nowIndex = this.imgNum - 1 : this.nowIndex--;
                        break; case "next": this.nowIndex === this.imgNum - 1 ? this.nowIndex = 0 : this.nowIndex++; break; default: this.nowIndex = t
                }var i = this;
                $(".imgList li", this.wrap).fadeOut().eq(this.nowIndex).fadeIn(function () { i.flag = !1 }),
                    $(".spot  span", this.wrap).css({ backgroundColor: this.spanColor }).eq(this.nowIndex % this.imgNum).css({ backgroundColor: this.activeSpanColor })
            },
            t.prototype.autoMove = function () {
                var t = this; this.time = setInterval
                    (function () { "left" == this.direction ? $(".left-btn", this.wrap).trigger("click") : $(".right-btn", this.wrap).trigger("click") },
                        t.moveTime
                    )
            },
            $.fn.extend(
...
null != commentElement && (commentElement.innerHTML += '<a id="switch-comment" href="javascript:void(0);" title="切换为Gitalk" target="_self"><i class="fa fas fa-toggle-off" aria-hidden="true"></i></a>',
    ...
    $("#switch-comment").click(function () { return switchComment(), !1 }),
    function () {
